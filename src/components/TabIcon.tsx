...
import { Entypo, Fontisto, MaterialCommunityIcons, AntDesign, FontAwesome6 } from '@expo/vector-icons';
...
export const iconMap: { [key: string]: { iconSet: React.ComponentType<any>, iconName: string } } = {
